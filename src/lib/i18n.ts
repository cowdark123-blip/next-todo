...
export const translations = {
  ...
  vi: {
    ...
    noTasksAll: 'Chưa có công việc nào. Hãy thêm một công việc!',
    noTasksImportant: 'Chưa có công việc nào. Hãy thêm và gắn sao công việc!',
    subtitleAll: 'Tất cả công việc bạn đã thêm sẽ ở đây',
    subtitleImportant: 'Tất cả công việc bạn đã gắn sao sẽ ở đây',
